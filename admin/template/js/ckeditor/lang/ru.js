	...
	"button":{
		...
		"forms":{
			"button":{
				...
				"select":{"title":"Свойства списка выбора",
		...
		"link":{
			...
			"anchor":{
				...
				"menu":"Изменить якорь","title":"Свойства якоря",
				"name":"Имя якоря",
		...
		"pastefromword":{
			...
			"title":"Вставить из Word","toolbar":"Вставить из Word"
		},
		"pastetext":{
